...
year = webVariables.YEAR = 2023
semester = webVariables.SEMESTER
department = webVariables.DEPARTMENT
code = webVariables.CODE
...
course_details = {
    ...
    "Start Time": data_json['meetings'][0]['startTime'],
    "End Time": data_json['meetings'][0]['endTime'],
...
# instead of json dump, the course details can be returned 
